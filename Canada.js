function step1() {
    ...
    step1.style.backgroundColor = 'black';
...
function step2() {
    ...
    `;
    step2.style.backgroundColor = 'black';
...
function step3() {
    ...
    `;
    step3.style.backgroundColor = 'black';
...
function step4() {
    ...
    `;
    step4.style.backgroundColor = 'black';
...
function step5() {
    ...
    `;
    step5.style.backgroundColor = 'black';
    step5.style.color = 'white';
    step2.style.backgroundColor = 'white';
    step2.style.color = 'black';
    step3.style.backgroundColor = 'white';
    step3.style.color = 'black';
...
function step6() {
    ...
    `;
    step6.style.backgroundColor = 'black';
    step6.style.color = 'white';
    step2.style.backgroundColor = 'white';
    step2.style.color = 'black';
    step3.style.backgroundColor = 'white';
    step3.style.color = 'black';
